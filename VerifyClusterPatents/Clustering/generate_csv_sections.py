...
if metric=="cosine":
    path=base_path+"VerifyClusterPatents/Clustering/section_cosine_distances.csv"
else:
    path=base_path+"VerifyClusterPatents/Clustering/section_euclidean_distances.csv"
